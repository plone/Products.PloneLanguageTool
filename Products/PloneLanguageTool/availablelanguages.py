...
'as' : {'native' : 'অসমিয়া', 'english' : 'Assamese', 'flag' : 'flag-as.gif'},
'ay' : {'native' : 'Aymara', 'english' : 'Aymara', 'flag' : 'flag-bo.gif'},
'az' : {'native' : 'Azəri Türkçəsi', 'english' : 'Azerbaijani', 'flag' : 'flag-az.gif'},
'ba' : {'native' : 'Bashkir', 'english' : 'Bashkir', 'flag' : 'flag-ba.gif'},
'be' : {'native' : 'Беларускі', 'english' : 'Belarussian', 'flag' : 'flag-by.gif'},
'bg' : {'native' : 'Български', 'english' : 'Bulgarian', 'flag' : 'flag-bg.gif'},
'bh' : {'native' : 'Bihari', 'english' : 'Bihari', 'flag' : 'flag-bh.gif'},
'bi' : {'native' : 'Bislama', 'english' : 'Bislama', 'flag' : 'flag-bi.gif'},
'bn' : {'native' : 'বাংলা', 'english' : 'Bengali', 'flag' : 'flag-bn.gif'},
'bo' : {'native' : 'བོད་སྐད་', 'english' : 'Tibetan', 'flag' : 'flag-bo.gif'},
'bs' : {'native' : 'Bosanski', 'english' : 'Bosnian', 'flag' : 'flag-ba.gif'},
'br' : {'native' : 'Brezhoneg', 'english' : 'Breton', 'flag' : 'flag-br.gif'},
'ca' : {'native' : 'Català', 'english' : 'Catalan', 'flag' : 'flag-cat.gif'},
'co' : {'native' : 'Corsu', 'english' : 'Corsican', 'flag' : 'flag-co.gif'},
...
'gd' : {'native' : 'Gàidhlig', 'english' : 'Scottish Gaelic', 'flag' : 'flag-gd.gif'},
'gl' : {'native' : 'Galego', 'english' : 'Galician', 'flag' : 'flag-gl.gif'},
'gn' : {'native' : 'Guarani', 'english' : 'Guarani', 'flag' : 'flag-py.gif'},
'gu' : {'native' : 'ગુજરાતી', 'english' : 'Gujarati', 'flag' : 'flag-gu.gif'},
...
'ia' : {'native' : 'Interlingua', 'english' : 'Interlingua', 'flag' : 'flag-ie.gif'},
'id' : {'native' : 'Bahasa Indonesia', 'english' : 'Indonesian', 'flag' : 'flag-id.gif'},
'ie' : {'native' : 'Interlingue', 'english' : 'Interlingue', 'flag' : 'flag-ie.gif'},
...
'ne' : {'native' : 'नेपाली', 'english' : 'Nepali', 'flag' : 'flag-ne.gif'},
...
'om' : {'native' : 'Oromo', 'english' : 'Oromo', 'flag' : 'flag-om.gif'},
'or' : {'native' : 'ଓଡ଼ିଆ', 'english' : 'Oriya'},
'pa' : {'native' : 'ਪੰਜਾਬੀ', 'english' : 'Punjabi', 'flag' : 'flag-pa.gif'},
'pl' : {'native' : 'Polski', 'english' : 'Polish', 'flag' : 'flag-pl.gif'},
'ps' : {'native' : 'پښتو', 'english' : 'Pashto', 'flag' : 'flag-ps.gif'},
...
'sm' : {'native' : 'Samoan', 'english' : 'Samoan', 'flag' : 'flag-sm.gif'},
'sn' : {'native' : 'Shona', 'english' : 'Shona', 'flag' : 'flag-sn.gif'},
...
'st' : {'native' : 'Sesotho', 'english' : 'Sesotho', 'flag' : 'flag-st.gif'},
...
'to' : {'native' : 'Lea faka-Tonga', 'english' : 'Tongan', 'flag' : 'flag-to.gif'},
'tr' : {'native' : 'Türkçe', 'english' : 'Turkish', 'flag' : 'flag-tr.gif'},
'ts' : {'native' : 'Tsonga', 'english' : 'Tsonga'},
'tt' : {'native' : 'татарча', 'english' : 'Tatar', 'flag' : 'flag-tt.gif'},
'tw' : {'native' : 'Twi', 'english' : 'Twi', 'flag' : 'flag-tw.gif'},
'ug' : {'native' : 'Uigur', 'english' : 'Uigur', 'flag' : 'flag-ug.gif'},
...
'za' : {'native' : 'Zhuang', 'english' : 'Zhuang', 'flag' : 'flag-za.gif'},
